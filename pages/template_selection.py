...
templates_second_row = [
    {
        ...
        "description": "Diese Vorlage nutzt ein zentrales Bild, z. B. eine Parkplatzsituation, dessen Bereiche über interaktive Hotspots erkundet werden können. Ziel ist es, räumliche Zusammenhänge anschaulich und selbstgesteuert zugänglich zu machen.",
        "structure-interaction": "Ein Einstieg führt in die Story ein, im Zentrum steht ein Bild mit klickbaren Hotspots, die weiterführende Infos liefern. Ein Ende fasst die relevanten Informationen zusammen.",
        "data-requirements": "Ein aussagekräftiges Bild sowie strukturierte Infos zu den einzelnen Hotspots, z. B. Texte oder Kennzahlen zu Stellplätzen, Beschilderung oder Zufahrten.",
        "suitable_for": "Diese Vorlage eignet sich besonders zur interaktiven Erschließung räumlicher Zusammenhänge, z. B. einer Parkplatzsituation, eines Fahrzeugs oder einer Haltestelle mit einzelnen erkundbaren Bereichen.",
    },
    # {
    #     "key": "story5",
    #     "label": "Demnächst",
